...
const Companies = () => {
    ...
    function search(haha){
        const filtered = originaldata.filter((e) => e['name'].toLowerCase().includes(haha.toLowerCase()) || e['country'].toLowerCase().includes(haha.toLowerCase()) || e['tva'].toLowerCase().includes(haha.toLowerCase()));
